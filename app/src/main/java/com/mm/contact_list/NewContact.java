 ...
 * Use the {@link NewContact#newInstance} factory method to
...
public class NewContact extends Fragment {
    ...
    public static NewContact newInstance(String param1, String param2) {
        NewContact fragment = new NewContact();
